...
def calculate_weakness_score(accuracy: float, avg_time: float, consistency: float) -> float:
    """
...
def get_topic_statistics(user: User) -> List[Dict[str, Any]]:
    """
...
def generate_recommendations(topic_analysis: List[Dict[str, Any]]) -> Dict[str, Any]:
    """
